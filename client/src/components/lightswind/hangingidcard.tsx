          ...
          {children ?? (
            <div className="flex flex-col h-full">
              ...
              >
                ...
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-white/20 backdrop-blur-sm mt-1 shadow-inner overflow-hidden">
                  <img
                    src={imageSrc || "https://firebasestorage.googleapis.com/v0/b/codewithmuhilandb.appspot.com/o/uploads%2Flightwind-logo.png?alt=media&token=6ba956f1-994c-46ca-9eda-6e46b5662eb9"}
                    alt={imageSrc ? "photo" : "logo"}
                    loading="lazy"
                    className={imageSrc ? "h-full w-full object-cover" : "h-9 w-9 object-contain filter brightness-0 invert"}
                  />
                </div>
              </div>
